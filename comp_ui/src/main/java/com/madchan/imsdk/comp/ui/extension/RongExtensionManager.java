...
//        if (mExtModules == null) {
//            Log.e(TAG, "Not init in the main process.");
//            return;
//        }
//        if (extensionModule == null || mExtModules.contains(extensionModule)) {
//            Log.e(TAG, "Illegal extensionModule.");
//            return;
//        }
//        Log.i(TAG, "registerExtensionModule " + extensionModule.getClass().getSimpleName());
...
//            return;
//        }
//        Log.i(TAG, "addExtensionModule " + extensionModule.getClass().getSimpleName());
//        mExtModules.add(extensionModule);
//    }
//
//    /**
...
//            Log.i(TAG, "unregisterExtensionModule " + extensionModule.getClass().getSimpleName());
//        } else {
//            Log.e(TAG, "Illegal extensionModule.");
//        }
//    }
...
//            Log.i(TAG, "add module " + rcbq.getClass().getSimpleName());
//            mExtModules.add(rcbq);
//        } catch (Exception e) {
//            Log.i(TAG, "Can't find " + DEFAULT_RC_STICKER);
//        }
//    }
//
...
//            Log.i(TAG, "add module " + callModule.getClass().getSimpleName());
//            mExtModules.add(callModule);
//        } catch (Exception e) {
//            Log.i(TAG, "Can't find" + DEFAULT_CALL_MODULE);
//        }
//    }
//}
