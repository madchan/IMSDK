...
import com.madchan.imsdk.comp.ui.extension.component.emoticon.AndroidEmoji;

public class RongExtensionViewModel extends ViewModel {
...
//    void setAttachedConversation(Conversation.ConversationType type, String targetId, EditText editText) {
    void setAttachedConversation(String targetId, EditText editText) {
...
//        }
    ...
    public void onSendClick() {
        if (TextUtils.isEmpty(mEditText.getText()) || TextUtils.isEmpty(mEditText.getText().toString().trim())) {
            Log.d(TAG, "can't send empty content.");
            mEditText.setText("");
            return;
        }
...
//        }
    ...
    public void collapseExtensionBoard() {
        if (mExtensionBoardState.getValue() != null && mExtensionBoardState.getValue().equals(false)) {
            Log.d(TAG, "already collapsed, return directly.");
            return;
        }
        Log.d(TAG, "collapseExtensionBoard");
